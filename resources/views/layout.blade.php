...
<html lang="en">
  ...
  <head>
    ...
    <title>Modarn Websolution</title>
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                      <img style="height: 50px;" src="assets/images/logo.jpeg" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="index.html" class="active">Home</a></li>
                        <li><a href="deals1.html">Playground One</a></li>
                        <li><a href="deals2.html">Playground Two</a></li>
                        <li><a href="deals.html">Indor</a></li>
                        <li><a href="deals3.html">Room Game</a></li>
    ...
    <div class="content-slider">
      ...
      <div class="slider">
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Football: a game of passion, strategy, teamwork, and unforgettable moments:</h2>
              <h1>Football</h1>
                  ...
                  <div class="more-info">
                    <div class="row">
                      <div class="col-lg-3 col-sm-6 col-6">
                        ...
                        <h4><span>Games Items:</span><br>20 Plus</h4>
                      </div>
                      <div class="col-lg-3 col-sm-6 col-6">
                        <i class="fa fa-globe"></i>
                        <h4><span>Territory:</span><br>2.400 KM<em>2</em></h4>
                      </div>
                      <div class="col-lg-3 col-sm-6 col-6">
                        <i class="fa fa-home"></i>
                        <h4><span>Regular Client :</span><br>2K Plus</h4>
                      </div>
                      <div class="col-lg-3 col-sm-6 col-6">
        ...
        <div id="top-banner-2" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Cricket: a game of skill, patience, strategy, and timeless elegance</h2>
              <h1>Cricket</h1>
              <div class="border-button"><a href="about.html">Go There</a></div>
            </div>
            <div class="container">
        ...
        <div id="top-banner-3" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Table tennis: fast-paced, skillful, strategic, and endlessly exhilarating in every rally :</h2>
              <h1>Table tennis</h1>
              <div class="border-button"><a href="about.html">Go There</a></div>
            </div>
            <div class="container">
        ...
        <div id="top-banner-4" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Carrom: a game of precision, strategy, skill, and intense focus on every shot. :</h2>
              <h1>Carrom</h1>
              <div class="border-button"><a href="about.html">Go There</a></div>
            </div>
            <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        ...
                        <ul class="info">
                          <li><i class="fa fa-clock"></i> 06:00 AM - 12:00 PM</li>
                          <li><i class="fa fa-globe"></i> 55.500 km2</li>
                          <li><i class="fa fa-user-group"></i> 4250 sits</li>
                        </ul>
                        <div class="text-button">
                          <a href="reservation.html">Need Directions ? <i class="fa fa-arrow-right"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        ...
                        <p>We hope this WoOx template is useful for you, please support us a to info [at] templatemo.com for our survival. We really appreciate your contribution.</p>
                        <ul class="info">
                          <li><i class="fa fa-clock"></i> 06:00 AM - 12:00 PM</li>
                          <li><i class="fa fa-globe"></i> 55.500 km2</li>
                          <li><i class="fa fa-user-group"></i> 4250 sits</li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 text-center">
                <h2 class="text-white mb-4">Our Schedule</h2>

                <div class="table-responsive">
                    <table class="schedule-table table" >
                        <thead style="background-color: #eb1c24;color: #FFFFFF;">
                            <tr>
  ...
  <div style="background: #eb1c24 !important; " class="call-to-action">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <h2>Are You Looking To Payground ?</h2>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2036 <a href="#">Modarn Websolution</a> Company. All rights reserved. 
